      ...
      >
          ...
          >
            ...
            <View style={styles.portfolioStats}>
              <View style={styles.statItem}>
                ...
                <View>
                  <Text style={styles.statValue}>
                    +{formatINR(mockPortfolio.dayGain)}
                  </Text>
              ...
              <View style={styles.statItem}>
                ...
                <View>
                  <Text style={styles.statValue}>
                    +{mockPortfolio.totalGainPercent}%
                  </Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.moversGrid}>
            {[
              ...
              { symbol: 'TCS', change: '-1.8%', positive: false },
              { symbol: 'HDFCBANK', change: '+3.2%', positive: true },
              { symbol: 'ICICIBANK', change: '+1.1%', positive: true },
            ].map((mover, index) => (
              <View
                key={index}
                style={[
              ...
              >
                <Text
                  style={[styles.moverSymbol, { color: theme.colors.text }]}
                >
                  {mover.symbol}
                </Text>
                <Text
        ...
        >
          ...
          <Text style={styles.aiDescription}>
            Based on your portfolio, consider diversifying into healthcare
            sector. NVDA shows strong momentum for next quarter.
          </Text>
